      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          double total_error = -pid.Kp * pid.p_error - pid.Kd * pid.d_error - pid.Ki * pid.i_error;
          ...
          // DEBUG
          std::cout << "CTE: " << cte << " Steering Value: " << steer_value << " Throttle Value: " << throttle_value << " Total Error: " << total_error << std::endl;
